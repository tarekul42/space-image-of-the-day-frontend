...
I built a backend (Node.js/TypeScript with Bun) to proxy NASA API calls and add SIMBAD astronomical enrichment. But I asked myself: *what happens when a user opens a new tab and my server is offline?*
